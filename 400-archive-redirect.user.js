    ...
    GM_xmlhttpRequest({
        ...
        onload: function (response) {
            if (response.status === 404) {
                ...
                banner.innerHTML = '<div style="background-color: #282828; color: white; padding: 10px; position: fixed; top: 0; left: 0; width: 100%; z-index: 9999;" id="404toarchive-banner">Redirecting to archived version, please wait...</div>';
